...
plt.plot(text, prompt1_scores, label='summary', color='red', marker='o', linestyle='dashed')
...
plt.plot(['doc', 'summary'], [doc_readability, prompt1_readability], color='red', marker='o', linestyle='dashed')
